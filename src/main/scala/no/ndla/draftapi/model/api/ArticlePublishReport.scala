...
case class ArticlePublishReport(
    @(ApiModelProperty @field)(description = "The ids of articles which was successfully published") succeeded: Seq[
      Long],
    @(ApiModelProperty @field)(description = "The ids of articles which failed to publish") failed: Seq[
...
case class FailedArticlePublish(
    @(ApiModelProperty @field)(description = "The id of an article which failed to be published") id: Long,
