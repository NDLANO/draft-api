  ...
  object StateTransitionRules {
    ...
    val StateTransitions: Set[StateTransition] = Set(
      (IMPORTED                   -> DRAFT)                      keepCurrentOnTransition,
       DRAFT                      -> DRAFT,
      (DRAFT                      -> PROPOSAL)                   keepStates Set(IMPORTED, PUBLISHED),
      (DRAFT                      -> PUBLISHED)                  keepStates Set(IMPORTED) require AdminRoles withSideEffect publishArticle,
       PROPOSAL                   -> PROPOSAL,
      (PROPOSAL                   -> DRAFT)                      keepStates Set(IMPORTED, PUBLISHED),
      (PROPOSAL                   -> QUEUED_FOR_LANGUAGE)        keepStates Set(IMPORTED, PUBLISHED),
      (PROPOSAL                   -> USER_TEST)                  keepStates Set(IMPORTED, PUBLISHED) keepCurrentOnTransition,
      ...
      (PROPOSAL                   -> AWAITING_QUALITY_ASSURANCE) keepStates Set(IMPORTED, PUBLISHED) keepCurrentOnTransition,
      (USER_TEST                  -> USER_TEST)                  keepStates Set(IMPORTED, PROPOSAL, PUBLISHED),
      (USER_TEST                  -> PROPOSAL)                   keepStates Set(IMPORTED, PUBLISHED),
      (USER_TEST                  -> DRAFT)                      keepStates Set(IMPORTED, PUBLISHED),
      ...
      (AWAITING_QUALITY_ASSURANCE -> DRAFT)                      keepStates Set(IMPORTED, PUBLISHED),
      (AWAITING_QUALITY_ASSURANCE -> QUEUED_FOR_LANGUAGE)        keepStates Set(IMPORTED, PUBLISHED),
      ...
      (QUALITY_ASSURED            -> DRAFT)                      keepStates Set(IMPORTED, PUBLISHED),
      ...
      (QUEUED_FOR_PUBLISHING      -> DRAFT)                      keepStates Set(IMPORTED, PUBLISHED),
      (PUBLISHED                  -> DRAFT)                      keepStates Set(IMPORTED, PUBLISHED),
      (PUBLISHED                  -> PROPOSAL)                   keepStates Set(IMPORTED, PUBLISHED),
      ...
      (AWAITING_UNPUBLISHING      -> DRAFT)                      keepStates Set(IMPORTED, PUBLISHED),
      ...
      (UNPUBLISHED                -> PROPOSAL)                   keepStates Set(IMPORTED),
      (UNPUBLISHED                -> DRAFT)                      keepStates Set(IMPORTED),
      ...
      (QUEUED_FOR_LANGUAGE        -> PROPOSAL)                   keepStates Set(IMPORTED, PUBLISHED),
      (QUEUED_FOR_LANGUAGE        -> TRANSLATED)                 keepStates Set(IMPORTED, PUBLISHED),
      TRANSLATED                  -> TRANSLATED,
      (TRANSLATED                 -> PROPOSAL)                   keepStates Set(IMPORTED, PUBLISHED),
      (TRANSLATED                 -> AWAITING_QUALITY_ASSURANCE) keepStates Set(IMPORTED, PUBLISHED)
    )
    // format: on
