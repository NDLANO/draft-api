...
trait StateTransitionRules {
  ...
  object StateTransitionRules {
    ...
    val StateTransitions: Set[StateTransition] = Set(
      ...
      (USER_TEST                  -> PUBLISHED)                  keepStates Set(IMPORTED) require AdminRoles withSideEffect publishArticle keepCurrentOnTransition,
      ...
      (QUALITY_ASSURED            -> PUBLISHED)                  keepStates Set(IMPORTED) require AdminRoles withSideEffect publishArticle keepCurrentOnTransition,
