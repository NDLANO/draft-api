...
class DraftControllerTest extends UnitSuite with TestEnvironment with ScalatraFunSuite {
  ...
  val jwtClainsAllRoles = ""
  ...
  val authHeadWithAllRoles = s"Bearer $jwtHeader.$jwtClaims.eL4ee3tTIxEObXzd5-TXXmADfsyUao9czrq74cRWPhE"
