...
object TestData {
  ...
  val apiArticleV2 = api.Article(
    ...
    api.Copyright(api.License("by", Some("Creative Commons Attribution 2.0 Generic"), Some("https://creativecommons.org/licenses/by/2.0/")), "", Seq(), List(), List(), None, None),
  ...
  val sampleDomainArticle = Article(
    ...
    Copyright("by", "", Seq(), List(), List(), None, None),
    Seq(),
    Seq(),
    Seq(),
    Seq(),
  ...
  val sampleDomainArticle2 = Article(
    ...
    Copyright("publicdomain", "", Seq(), List(), List(), None, None),
    Seq(),
    Seq(),
    Seq(),
    Seq(),
  ...
  val newArticleV2 = api.NewArticle(
    ...
    None,
    None,
    api.Copyright(api.License("publicdomain", None, None), "", Seq(), List(), List(), None, None),
    None,
    "standard",
    "en"
  )
  ...
  val sampleConcept = Concept(
    ...
    Some(Copyright("publicdomain", "", Seq(), List(), List(), None, None)),
    DateTime.now().minusDays(4).toDate,
    DateTime.now().minusDays(2).toDate
  )
  ...
  val sampleApiConcept = api.Concept(
    ...
    Some(api.Copyright(api.License("publicdomain", None, None), "", Seq(), List(), List(), None, None)),
    DateTime.now().minusDays(4).toDate,
    DateTime.now().minusDays(2).toDate,
    Set("nb")
  )
