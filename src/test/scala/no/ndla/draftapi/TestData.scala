...
object TestData {
  ...
  val sampleTopicArticle = Article(
    ...
    Set(ArticleTitle("test", "en")),
    Set(ArticleContent("<section><div>test</div></section>", "en")),
    Some(publicDomainCopyright),
    Set.empty,
    Set.empty,
    Set(VisualElement("image", "en")),
    Set(ArticleIntroduction("This is an introduction", "en")),
    Set.empty,
    Set.empty,
  ...
  val sampleDomainArticle = Article(
    ...
    Option(2),
    domain.Status(DRAFT, Set.empty),
    Set(ArticleTitle("title", "nb")),
    Set(ArticleContent("content", "nb")),
  ...
  val sampleDomainArticle2 = Article(
    ...
    domain.Status(DRAFT, Set.empty),
    Set(ArticleTitle("test", "en")),
    Set(ArticleContent("<article><div>test</div></article>", "en")),
