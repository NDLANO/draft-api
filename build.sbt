...
assembly / assemblyMergeStrategy := {
  ...
  case PathList("com", "sun", "jna", "ELFAnalyser.class")                 => MergeStrategy.first
  case PathList("com", "sun", "jna", "Native.class")                      => MergeStrategy.first
  case PathList("com", "sun", "jna", "Platform.class")                    => MergeStrategy.first
  case PathList("com", "sun", "jna", "Version.class")                     => MergeStrategy.first
  case PathList("com", "sun", "jna", "linux-x86-64", "libjnidispatch.so") => MergeStrategy.first
  case x =>
